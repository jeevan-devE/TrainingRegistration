...
{
    public abstract class TrainingRegistrationWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TrainingRegistrationWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TrainingRegistrationWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TrainingRegistrationDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TrainingRegistrationDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TrainingRegistrationDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TrainingRegistrationDbContext, Task<T>> func)
        {
            T result;
