...
namespace TrainingRegistration.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = TrainingRegistrationConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(TrainingRegistrationDbContext context)
        {
            _context = context;
        }
